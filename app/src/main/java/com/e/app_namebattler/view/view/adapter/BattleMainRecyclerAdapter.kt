...
class BattleMainRecyclerAdapter(private val memberList: MutableList<MemberStatusData>) :
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): MyViewHolder {
        ...
        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.data_battle_main_character_status, viewGroup, false)
    ...
    class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val Name: TextView =
            view.findViewById(R.id.data_battle_main_character_status_member_name_text_id)
        val Hp: TextView =
            view.findViewById(R.id.data_battle_main_character_status_member_hp_text_id)
        val Mp: TextView =
            view.findViewById(R.id.data_battle_main_character_status_member_mp_text_id)
        val Status: TextView =
            view.findViewById(R.id.data_battle_main_character_status_member_status_text_id)
        val aa: LinearLayout =
            view.findViewById(R.id.data_battle_main_character_status_linearLayout_id) //試し
