...
enum class AllyFighterImageData(private val characterImage: Int) {
    ...
    AF01(R.drawable.fighter_ally01), AF02(R.drawable.fighter_ally02), AF03(R.drawable.fighter_ally03), AF04(
...
enum class AllyWizardImageData(private val characterImage: Int) {
    ...
    AW01(R.drawable.wizard_ally01), AW02(R.drawable.wizard_ally02), AW03(R.drawable.wizard_ally03), AW04(
...
enum class AllyPriestImageData(private val characterImage: Int) {
    ...
    AP01(R.drawable.priest_ally01), AP02(R.drawable.priest_ally02), AP03(R.drawable.priest_ally03), AP04(
...
enum class EnemyFighterImageData(private val characterImage: Int) {
    ...
    EF01(R.drawable.fighter_enemy01), EF02(R.drawable.fighter_enemy02), AF03(R.drawable.fighter_enemy03), EF04(
...
enum class EnemyWizardImageData(private val characterImage: Int) {
    ...
    EW01(R.drawable.wizard_enemy01), EW02(R.drawable.wizard_enemy02), EW03(R.drawable.wizard_enemy03), EW04(
...
enum class EnemyPriestImageData(private val characterImage: Int) {
    ...
    EP01(R.drawable.priest_enemy01), EP02(R.drawable.priest_enemy02), EP03(R.drawable.priest_enemy03), EP04(
